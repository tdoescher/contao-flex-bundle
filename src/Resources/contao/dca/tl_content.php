...
$GLOBALS['TL_DCA']['tl_content']['palettes']['flex_open'] = '{type_legend},type;{flex_legend},flex_sm,flex_class,flex_repeat,flex_bootstrap,flex_multiline;{flex_extended_legend},flex_xs,flex_md,flex_lg,flex_xl,flex_justify,flex_align,flex_gap;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop';
